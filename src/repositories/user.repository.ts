...
import {User, UserRelations, Userrolemapping, CfsUserRegistration} from '../models';
...
export class UserRepository extends DefaultCrudRepository<
  ...
  public readonly userrolemappings: HasManyRepositoryFactory<Userrolemapping, typeof User.prototype.userId>;

  public readonly cfsUserRegistration: HasOneRepositoryFactory<CfsUserRegistration, typeof User.prototype.userId>;
  ...
  constructor(
    ...
    >, @repository.getter('CfsUserRegistrationRepository') protected cfsUserRegistrationRepositoryGetter: Getter<CfsUserRegistrationRepository>,
  ) {
    super(User, dataSource);
    this.cfsUserRegistration = this.createHasOneRepositoryFactoryFor('cfsUserRegistration', cfsUserRegistrationRepositoryGetter);
    this.registerInclusionResolver('cfsUserRegistration', this.cfsUserRegistration.inclusionResolver);
