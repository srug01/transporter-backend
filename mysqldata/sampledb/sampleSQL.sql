CREATE DATABASE  IF NOT EXISTS `transporter2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `transporter2`;
...
INSERT INTO `cfsmaster` VALUES (1,'New CFS','8741020356','cfs@new.in','Add1','','LandMark','411125','NCFS001','','','','Bhushan','9874102053','','','','',1,1,1,1,'2020-09-30 07:05:05',1,'2020-09-30 07:05:05',1);
...
INSERT INTO `cfsuserregistration` VALUES (1,1,7,'CFS ADMIN ','','','9874102563','admin@cfs.in','123456789',2,1,1,1,'2020-09-30 07:06:15',1,'2020-09-30 07:06:15'),(2,1,8,'CFS Super Admin','','','8741023568','superadmin@cfs.in','123456789',3,1,1,1,'2020-09-30 07:07:37',1,'2020-09-30 07:07:37'),(3,1,9,'CFS Viewer','','','8412560032','viewer@cfs.in','123456789',4,1,1,1,'2020-09-30 07:08:49',1,'2020-09-30 07:08:49');
...
INSERT INTO `locationmaster` VALUES (1,'Mumbai',1,1,'2020-09-30 07:03:05',NULL,NULL,1);
...
INSERT INTO `portmaster` VALUES (1,'JNPT',1,1,'Add11','','','410214','Bhushan','8745120365',1,1,'2020-09-30 07:03:48',1,'2020-09-30 07:03:48','','');
...
update transporter2.order ord 
inner join transporter2.suborder sub  on ord.orderId = sub.orderId 
...
INSERT INTO `user` VALUES (1,'global@admin.in','$2a$10$oPPsc5/hTuLA0YaaBspR6u6OubUj5D49kkWxe3KVVod.fbsBkg29m','Global','Admin','9874561203',1,'[\"AccessAuthFeature\"]'),(2,'admin@cfs.in','$2a$10$a.cAI5dPtOPi1NQh5HLAWevpzv367Yz85pg7J4/hmjG2FKJEFse.u','CFS ADMIN ','CFS ADMIN ','9874102563',7,'[\"AccessAuthFeature\"]'),(3,'superadmin@cfs.in','$2a$10$jfkvrAKDqqG.gdKDtBn4HulXVE5J60OtCXx71MvoUrQ9E7NnofLxS','CFS Super Admin','CFS Super Admin','8741023568',8,'[\"AccessAuthFeature\"]'),(4,'viewer@cfs.in','$2a$10$PxTdoWOl3DWsg6k4tzBXEudn6U/Ybms5I.Hs.ASr5KqDAAa1cgvuK','CFS Viewer','CFS Viewer','8412560032',9,'[\"AccessAuthFeature\"]'),(5,'customer@cfs.in','$2a$10$lY51LC39FgiqbmKV0M6PNu8Go9iVEItrPKdUrBGrOpm4xs/9wAATG','CFS','Customer','7789456120',4,'[\"AccessAuthFeature\"]'),(6,'transporter@app.in','$2a$10$vVg.duTiojrcGHiU6ZhHC.Z9T3NN5qPOwLw.ZAHEegRz9g0YsV92a','Transporter','First','8745210365',5,'[\"AccessAuthFeature\"]'),(7,'driver@app.in','$2a$10$oCZMF3lrLnOLPQc3GnITneJcQ1kNF2ZGbb24DJaOk.un5XrfAvrxW','Driver','First','9874125036',6,'[\"AccessAuthFeature\"]');
...
--
-- Dumping events for database 'transporter2'
--
...
Delete from transporter2.trip;
Delete from transporter2.bidusermapping;
Delete from transporter2.bid;
Delete from transporter2.container;
Delete from transporter2.truck;
Delete from transporter2.suborder;
Delete from transporter2.order;
...
Select cm.* from transporter2.cfsmaster cm where isActive = 1;
else
Select cm.* from transporter2.cfsmaster cm
Inner Join transporter2.cfsuserregistration cur on cm.cfsMasterId = cur.cfsMasterId
...
Select cfs.cfsMasterId,c.containerMasterId,c.containerMasterName,
 ...
 from transporter2.weightmaster w
Inner Join transporter2.containermaster c on c.containerMasterId = w.containerMasterId
Left Outer Join transporter2.cfsmaster cfs on cfs.cfsMasterId = cfs_master_Id
left Outer Join transporter2.yardmaster y on 
 cfs.portMasterId = y.portMasterId  
Left Outer Join transporter2.cfsyardratemaster yrm on 
...
left Outer Join transporter2.yardmaster y on 
 cfs.portMasterId = y.portMasterId  
Left Outer Join transporter2.yardcfsratemaster yrm on 
c.containerMasterId = yrm.containerMasterId and w.weightMasterId = yrm.weightMasterId
and yrm.cfsMasterId = cfs_master_Id and yrm.yardMasterId = y.yardMasterId
Where c.isActive = 1;
...
Inner Join transporter2.containermaster c on c.containerMasterId = w.containerMasterId
Left Outer Join transporter2.cfsmaster cfs on cfs.cfsMasterId = cfs_master_Id
Left Outer Join transporter2.cfsportratemaster prm on 
...
Inner Join transporter2.containermaster c on c.containerMasterId = w.containerMasterId
Left Outer Join transporter2.cfsmaster cfs on cfs.cfsMasterId = cfs_master_Id
Left Outer Join transporter2.portcfsratemaster prm on 
c.containerMasterId = prm.containerMasterId and w.weightMasterId = prm.weightMasterId
and prm.cfsMasterId = cfs_master_Id and prm.portMasterId = cfs.portMasterId
Where c.isActive = 1;
...
Select distinct  c.* from transporter2.containermaster c
Inner Join transporter2.cfsyardratemaster yrm on c.containerMasterId = yrm.containerMasterId
Inner Join transporter2.cfsuserregistration cur on yrm.cfsMasterId = cur.cfsMasterId
Where cur.userId = user_Id and yrm.yardMasterId = port_yard_Id;

ELSEIF (type_Id = 2)  Then -- CFS To Port
Select distinct c.* from transporter2.containermaster c
Inner Join transporter2.cfsportratemaster crm on c.containerMasterId = crm.containerMasterId
Inner Join transporter2.cfsuserregistration cur on crm.cfsMasterId = cur.cfsMasterId
Where cur.userId = user_Id and crm.portMasterId = port_yard_Id;

ELSEIF (type_Id = 3)  Then -- Yard To CFS
Select distinct c.* from transporter2.containermaster c
Inner Join transporter2.yardcfsratemaster crm on c.containerMasterId = crm.containerMasterId
Inner Join transporter2.cfsuserregistration cur on crm.cfsMasterId = cur.cfsMasterId
Where cur.userId = user_Id and crm.yardMasterId = port_yard_Id;

ELSEIF (type_Id = 4)  Then -- Port To CFS
Select distinct c.* from transporter2.containermaster c
Inner Join transporter2.portcfsratemaster crm on c.containerMasterId = crm.containerMasterId
Inner Join transporter2.cfsuserregistration cur on crm.cfsMasterId = cur.cfsMasterId
Where cur.userId = user_Id and crm.portMasterId = port_yard_Id;
...
Select distinct p.* from transporter2.portmaster p
Inner Join transporter2.cfsuserregistration cur on cur.userId = user_Id 
Inner join transporter2.cfsmaster cfs on cur.cfsMasterId = cfs.cfsMasterId and p.portMasterId = cfs.portMasterId
-- Left Outer Join transporter2.cfsportratemaster crm on p.portMasterId = crm.portMasterId and crm.cfsMasterId = cur.cfsMasterId
-- Left Outer Join transporter2.portcfsratemaster prm on p.portMasterId = prm.portMasterId and prm.cfsMasterId = cur.cfsMasterId
...
Select distinct w.* from transporter2.weightmaster w
Inner Join transporter2.cfsyardratemaster yrm on w.weightMasterId = yrm.weightMasterId
Inner Join transporter2.cfsuserregistration cur on yrm.cfsMasterId = cur.cfsMasterId
...
Select distinct w.* from transporter2.weightmaster w
Inner Join transporter2.cfsportratemaster crm on w.weightMasterId = crm.weightMasterId
Inner Join transporter2.cfsuserregistration cur on crm.cfsMasterId = cur.cfsMasterId
...
Select distinct w.* from transporter2.weightmaster w
Inner Join transporter2.yardcfsratemaster crm on w.weightMasterId = crm.weightMasterId
Inner Join transporter2.cfsuserregistration cur on crm.cfsMasterId = cur.cfsMasterId
Where cur.userId = user_Id and crm.containerMasterId= container_Id
...
Select distinct w.* from transporter2.weightmaster w
Inner Join transporter2.portcfsratemaster crm on w.weightMasterId = crm.weightMasterId
Inner Join transporter2.cfsuserregistration cur on crm.cfsMasterId = cur.cfsMasterId
Where cur.userId = user_Id and crm.containerMasterId= container_Id
and crm.portMasterId = port_yard_Id;
...
Select distinct y.* from transporter2.yardmaster y
Inner Join transporter2.cfsuserregistration cur on cur.userId = user_Id 
Inner Join transporter2.cfsmaster cm on cm.cfsMasterId = cur.cfsMasterId and cm.portMasterId = y.portMasterId
-- Left Outer Join transporter2.yardcfsratemaster yrm on y.yardMasterId = yrm.yardMasterId and yrm.cfsMasterId = cur.cfsMasterId
-- Left Outer Join transporter2.cfsyardratemaster crm on y.yardMasterId = crm.yardMasterId and crm.cfsMasterId = cur.cfsMasterId
Where cur.userId = user_Id;
...
BEGIN
Select d.* from transporter2.driver d
Inner join transporter2.drivertransportermapping dtm on d.userId = dtm.driverId
...
declare role_Id int;
Select typeSyscode into role_Id from transporter2.user where userId = user_Id;
...
left join transporter2.portterminalmaster ptm on ptm.portTerminalId = ord.portTerminalId
...
DATE_FORMAT(ord.createdOn,'%d-%b-%Y') as CreatedOn
from transporter2.order ord
left outer join transporter2.portterminalmaster ptm on ptm.portTerminalId = ord.portTerminalId
...
Select typeSyscode into role_Id from transporter2.user
where userId = user_Id;
...
from transporter2.order ord
inner join transporter2.suborder subo on subo.orderId= ord.orderId
left outer join transporter2.containermaster c on subo.containerType = c.containerMasterId
left outer join transporter2.weightmaster w on subo.containerWeightType = w.weightMasterId
...
from transporter2.trip t
Inner Join transporter2.suborder so on t.subOrderId = so.subOrderId
Inner Join transporter2.order ord on so.orderId = ord.orderId
Left Outer Join transporter2.vehiclemaster v on v.vehicleMasterId = t.assignedVehicle
Left Outer Join transporter2.driver u on u.driverId = t.assignedDriver
left outer join transporter2.weightmaster wm on wm.weightMasterId = v.vehiclecapacity
left outer join transporter2.containermaster cm on cm.containerMasterId = v.vehicletype
left outer join transporter2.containermaster c on so.containerType = c.containerMasterId
left outer join transporter2.weightmaster w on so.containerWeightType = w.weightMasterId
left outer join transporter2.user usr on usr.userId = t.createdBy
...
from transporter2.trip t
Inner join transporter2.suborder subo on t.subOrderId = subo.subOrderId
Inner Join transporter2.order ord on subo.orderId = ord.orderId
left outer join transporter2.vehiclemaster vhl on vhl.vehicleMasterId = t.assignedVehicle
left outer join transporter2.driver dusr on dusr.driverId = t.assignedDriver
left outer join transporter2.weightmaster wm on wm.weightMasterId = vhl.vehiclecapacity
left outer join transporter2.containermaster cm on cm.containerMasterId = vhl.vehicletype
left outer join transporter2.containermaster c on subo.containerType = c.containerMasterId
left outer join transporter2.weightmaster w on subo.containerWeightType = w.weightMasterId
left outer join transporter2.user usr on usr.userId = t.createdBy;
...
Select v.* from transporter2.vehiclemaster v
Inner join transporter2.vehicletransportermapping vtm on v.vehicleMasterId = vtm.vehicleMasterId
...
from transporter2.order ord
inner join transporter2.suborder subo on subo.orderId= ord.orderId
Inner join  transporter2.bid b on b.subOrderId= subo.subOrderId
Inner join transporter2.bidusermapping bum on bum.bidId = b.bidId
Inner join transporter2.user usr on usr.userId = bum.userId
...
if roleId = 5 then -- Transporter
    ...
    -- (select  IFNULL(bidValue,0) from transporter2.bidusermapping where bidId = b.bidId and userId = user_Id 
    -- ) as bidValue
    ...
    from transporter2.order ord
    Inner Join transporter2.suborder sub on ord.orderId = sub.orderId
    Inner Join  transporter2.bid b  on sub.subOrderId = b.subOrderId
    Inner Join transporter2.bidusermapping bum on b.bidId = bum.bidId and bum.userId = user_Id 
    -- Inner Join transporter2.bidusermapping bm on bm.userId = user_Id 
    Left Outer Join transporter2.containermaster com on sub.containerType= com.containerMasterId
    Left Outer Join transporter2.weightmaster wem on containerWeightType=wem.weightMasterId
    Where b.isActive = 1 ;  
    ...
    Left Outer Join transporter2.suborder sub on b.subOrderId = sub.subOrderId
    Left Outer Join transporter2.order ord on sub.orderId = ord.orderId
    Left Outer Join transporter2.bidusermapping bm on b.bidId = bm.bidId
    Left Outer Join transporter2.containermaster com on sub.containerType= com.containerMasterId
    Left Outer Join transporter2.weightmaster wem on containerWeightType=wem.weightMasterId
    ;
...
Select sub.subOrderId,
    ...
    sub.subOrderTotalMargin as originalRate,bum.bidusermappingId
    from transporter2.order ord
    Left Outer Join transporter2.suborder sub on ord.orderId = sub.orderId
    Left Outer Join  transporter2.bid b  on sub.subOrderId = b.subOrderId
    Left Outer Join transporter2.bidusermapping bum on b.bidId = bum.bidId and bum.userId = user_Id 
    Left Outer Join transporter2.containermaster com on sub.containerType= com.containerMasterId
    Left Outer Join transporter2.weightmaster wem on containerWeightType=wem.weightMasterId
...
DATE_FORMAT(ord.createdOn,'%d-%b-%Y') as CreatedOn
from transporter2.order ord
inner join transporter2.portterminalmaster ptm on ptm.portTerminalId = ord.portTerminalId;
...
from transporter2.bid b
Left Outer Join transporter2.bidusermapping bm on b.bidId = bm.bidId
Inner Join transporter2.suborder subo on b.subOrderId = subo.subOrderId
Inner Join transporter2.order ord on subo.orderId = ord.orderId
left outer join transporter2.containermaster c on subo.containerType = c.containerMasterId
left outer join transporter2.weightmaster w on subo.containerWeightType = w.weightMasterId
left outer join transporter2.user usr on usr.userId = bm.userId;
...
c.containerMasterName,w.weightDesc
from transporter2.bid b
Inner Join transporter2.bidusermapping bm on b.bidId = bm.bidId and bm.userId = user_Id
Inner Join transporter2.suborder subo on b.subOrderId = subo.subOrderId
Inner Join transporter2.order ord on subo.orderId = ord.orderId
left outer join transporter2.containermaster c on subo.containerType = c.containerMasterId
left outer join transporter2.weightmaster w on subo.containerWeightType = w.weightMasterId
...
DATE_FORMAT(ord.createdOn,'%d-%b-%Y') as CreatedOn
from transporter2.order ord
Left Outer join transporter2.user usr on ord.createdBy = usr.userId
left join transporter2.portterminalmaster ptm on ptm.portTerminalId = ord.portTerminalId
where ord.isDeleted = 0
...
from transporter2.order ord
inner join transporter2.suborder subo on subo.orderId= ord.orderId
left outer join transporter2.bid b on subo.orderId = b.subOrderId
left outer join transporter2.containermaster c on subo.containerType = c.containerMasterId
left outer join transporter2.weightmaster w on subo.containerWeightType = w.weightMasterId
where ord.orderId = order_Id 
...
left outer join transporter2.weightmaster w on subo.containerWeightType = w.weightMasterId
left outer join transporter2.user usr on usr.userId = t.createdBy
left outer join transporter2.user stusr on stusr.userId = t.startedBy
left outer join transporter2.user edusr on edusr.userId = t.stoppeddBy
...
Inner Join transporter2.order ord on so.orderId = ord.orderId
Left Outer Join transporter2.vehiclemaster v on v.vehicleMasterId = t.assignedVehicle
Left Outer Join transporter2.user u on u.userId = t.assignedDriver
Where t.tripId = trip_Id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
Select fromValue into  fromVal from transporter2.timeslotmaster Where timeslotMasterId = timeSlotId;
Set fromVal = Concat(cast(order_date as char(12)) ,  fromVal ,":00:00"); 

Update transporter2.order set orderDate = fromVal where orderid = order_Id;
...
wt.weightDesc
from transporter2.cfsuserregistration reg
Inner Join transporter2.cfsmaster mas on reg.cfsMasterId = mas.cfsMasterId
Inner Join transporter2.cfsratemaster rat on mas.portMasterId = rat.portMasterId
Inner join transporter2.containermaster cont 
on rat.containerMasterId = cont.containerMasterId 
Inner Join transporter2.weightmaster wt 
...
inner join transporter2.suborder subo on subo.orderId= ord.orderId
left outer join transporter2.portterminalmaster ptm on ptm.portTerminalId = ord.portTerminalId
left outer join  transporter2.bid bid on bid.subOrderId= subo.subOrderId
left outer join transporter2.bidusermapping bum on bum.bidId = bid.bidId
left outer join transporter2.user usr on usr.userId = bum.userId
left outer join transporter2.trip trp on trp.subOrderId = subo.subOrderId
left outer join transporter2.vehiclemaster vhl on vhl.vehicleMasterId = trp.assignedVehicle
left outer join transporter2.driver dusr on dusr.driverId = trp.assignedDriver
left outer join transporter2.weightmaster wm on wm.weightMasterId = vhl.vehiclecapacity
left outer join transporter2.containermaster cm on cm.containerMasterId = vhl.vehicletype
...
update transporter2.bid  b
inner join transporter2.suborder sub on b.subOrderId = sub.subOrderId
inner join transporter2.order ord  on sub.orderid = ord.orderid
inner join transporter2.bidschedulemaster bis on TIMESTAMPDIFF(HOUR, ord.createdOn, ord.orderdate) between bis.fromHour and bis.ToHour
...
(
	...
	FROM transporter2.bid bd
	inner join transporter2.bidusermapping bum on bum.bidId = bd.bidId
	inner join transporter2.suborder subo on subo.subOrderId = bd.subOrderId
...
FROM transporter2.bidusermapping
)t1
...
FROM transporter2.bidusermapping bum
inner join transporter2.bid bd on bd.bidId = bum.bidId
inner join transporter2.suborder subo on subo.subOrderId= bd.subOrderId
inner join transporter2.order ord on ord.orderId = subo.orderId
left outer join transporter2.trip trip on trip.subOrderId = subo.subOrderId 
where biduserStatus = 'BID_USER_CONFIRMED' and tripId is null;

update transporter2.suborder sub 
inner join transporter2.trip trp  on sub.subOrderId = trp.subOrderId 
set sub.suborderStatus = 'SUB_ORDER_BID_ASSIGNED',
	suborderStatusId = 12
where suborderStatusId != 12;


update transporter2.bid bd 
inner join transporter2.trip trp  on bd.subOrderId = trp.subOrderId 
set bd.bidStatus = 'BID_ASSIGNED',
	bd.bidStatusId = 2, 
    bd.isActive = 0
where bidStatusId != 2;

update  transporter2.bidusermapping bum  
inner join transporter2.bid bd on bum.bidid = bd.bidid
inner join transporter2.trip trp  on bd.subOrderId = trp.subOrderId 
...
where biduserStatusId != 5 and biduserStatusId != 22;
 ...
 update transporter2.bid set cutofftime = now();
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
from transporter2.order ord
inner join transporter2.suborder subo on subo.orderId= ord.orderId
inner join  transporter2.bid bid on bid.subOrderId= subo.subOrderId
left outer join transporter2.bidusermapping bum on bum.bidId = bid.bidId
left outer join transporter2.user usr on usr.userId = bum.userId
left outer join transporter2.trip trp on trp.subOrderId = subo.subOrderId
left outer join transporter2.containermaster cm on cm.containerMasterId = subo.containerType
left outer join transporter2.weightmaster wm on wm.weightMasterId = subo.containerWeightType
...
/*If(master_type_Id = 1) then

Insert into transporter2.cfsyardratemaster
SELECT
  json_tb.item_id,
  json_tb.model_number,
  json_tb.quantity,
...
select bidId into bid_Id from transporter2.bid where subOrderId = sub_orderId;
If(bid_Id = 0) then
	Insert into transporter2.bid(bidName,originalRate,exhibitionDate,
    ...
    Insert into transporter2.bidusermapping(bidId,userId,bidValue,biduserStatus,biduserStatusId,createdBy,createdOn)
    values(bid_Id,user_Id,bidVal,'BID_USER_EDIT',4,user_Id,Now());
        
else    

IF Exists(Select * from transporter2.bidusermapping	Where bidId = bid_Id and userId = user_Id) then
    Update transporter2.bidusermapping  set bidValue = bidVal, biduserStatus = 'BID_USER_EDIT',biduserStatusId = 4,
...
Update transporter2.order set orderDate = CONCAT(DATE(order_date),' ',fromVal) where orderid = order_Id;
...
Begin
   ...
   REPEAT
     ...
     IF NOT exit_loop  THEN
		...
		select rate * trucks, orderMarginRate into
			...
			from transporter2.portcfsratemaster
		...
		ElseIf masterType = 2 then -- CFS To Port
			select rate * trucks, orderMarginRate into
             cfsRate,profit_margin
			from transporter2.cfsportratemaster
        ...
        ElseIf masterType = 3 then -- Yard To CFS
			select rate * trucks, orderMarginRate into
             cfsRate,profit_margin
			from transporter2.yardcfsratemaster yrm
            inner join transporter2.cfsmaster cm on yrm.portMasterId = cm.portMasterId
        ...
        ElseIf masterType = 1 then -- CFS To Yard
			select rate * trucks, orderMarginRate into
             cfsRate,profit_margin
			from transporter2.cfsyardratemaster yrm
            inner join transporter2.cfsmaster cm on yrm.portMasterId = cm.portMasterId
            and yrm.cfsMasterId = cm.cfsMasterId 
   ...
   close order_cursor;
    ...
    -- Insert SubOrder
Insert into transporter2.suborder(orderId,subOrderTotal,bidLimit,isDelete,createdBy,
...
when ord.masterTypeId = 2 then  -- CFS To Port
	(Select rate  from transporter2.cfsportratemaster 
...
when ord.masterTypeId = 4 then  -- Port To CFS
	(Select rate  from transporter2.portcfsratemaster 
	where cfsMasterId = ord.destinationId and portMasterId = ord.sourceId
	and containerMasterId = c.containerMasterId and weightMasterId = c.weightType)
when ord.masterTypeId = 3 then  -- Yard To CFS
	(Select rate 
    from transporter2.yardcfsratemaster yc
    inner join transporter2.cfsmaster cfs on yc.cfsMasterId = cfs.cfsMasterId and yc.portMasterId = cfs.portMasterId
...
when ord.masterTypeId = 1 then  -- CFS To Yard
	(Select rate  
    from transporter2.cfsyardratemaster cy
    inner join transporter2.cfsmaster cfs on cy.cfsMasterId = cfs.cfsMasterId and cy.portMasterId = cfs.portMasterId
...
case 
when ord.masterTypeId = 2 then  -- CFS To Port
	(Select  bidMarginRate from transporter2.cfsportratemaster 
	where cfsMasterId = ord.sourceId and portMasterId = ord.destinationId
	and containerMasterId = c.containerMasterId and weightMasterId = c.weightType)
when ord.masterTypeId = 4 then  -- Port To CFS
	(Select bidMarginRate from transporter2.portcfsratemaster 
	where cfsMasterId = ord.destinationId and portMasterId = ord.sourceId
	and containerMasterId = c.containerMasterId and weightMasterId = c.weightType)
when ord.masterTypeId = 3 then  -- Yard To CFS
...
case 
when ord.masterTypeId = 2 then  -- CFS To Port
	(Select (rate - ((rate * orderMarginRate) / 100)) from transporter2.cfsportratemaster 
	where cfsMasterId = ord.sourceId and portMasterId = ord.destinationId
	and containerMasterId = c.containerMasterId and weightMasterId = c.weightType)
when ord.masterTypeId = 4 then  -- Port To CFS
	(Select (rate - ((rate * orderMarginRate) / 100)) from transporter2.portcfsratemaster 
	where cfsMasterId = ord.destinationId and portMasterId = ord.sourceId
	and containerMasterId = c.containerMasterId and weightMasterId = c.weightType)
when ord.masterTypeId = 3 then  -- Yard To CFS
...
-- Dump completed on 2020-09-30 12:50:14
