...
--
-- Table structure for table `transporterinvoice`
--

DROP TABLE IF EXISTS `transporterinvoice`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `transporterinvoice` (
  `transporterInvoiceId` int NOT NULL AUTO_INCREMENT,
  `tripId` int NOT NULL,
  ...
  `modifiedBy` int DEFAULT NULL,
  `modifiedOn` varchar(512) DEFAULT NULL,
  PRIMARY KEY (`transporterInvoiceId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `transporterinvoice`
--

LOCK TABLES `transporterinvoice` WRITE;
/*!40000 ALTER TABLE `transporterinvoice` DISABLE KEYS */;
/*!40000 ALTER TABLE `transporterinvoice` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `trip` (
  ...
  `transporterInvoiceGenerated` tinyint(1) DEFAULT NULL,
  `transporterInvoiceId` int DEFAULT NULL,
  PRIMARY KEY (`tripId`)
...
Delete from transporter.tripinvoice;
Delete from transporter.orderinvoice;
...
Elseif(amount > outstand and outstand > 0)then
	set cur_outstand= 0;
    set cur_availLimit = availLimit + (amount - outstand);
     set cur_bal = 0;    
Elseif(amount > outstand and outstand = 0) then
	set cur_outstand= 0;
    -- set cur_availLimit = credLimit;
...
-- Dump completed on 2020-12-17  2:32:14
